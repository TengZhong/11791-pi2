 ...
 */
public class TestEleAnnotation implements ProcessingService
{
    /**
    ...
    public String execute(String input) {
        ...
        try {
          ...
          while ((line = bf.readLine()) != null) {
            ...
            if (parts[0].equals("Q")) { // parse Question
              parts = line.split(" ", 2);
              type = "Question";
              id = "Question";
